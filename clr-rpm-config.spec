...
Version  : 262
Release  : 260
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-262.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-262.tar.xz
...
%prep
%setup -q -n clr-rpm-config-262
cd %{_builddir}/clr-rpm-config-262
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682633679
