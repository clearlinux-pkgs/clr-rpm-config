...
Version  : 280
Release  : 279
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-280.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-280.tar.xz
...
%prep
%setup -q -n clr-rpm-config-280
cd %{_builddir}/clr-rpm-config-280
pushd ..
cp -a clr-rpm-config-280 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743626895
