...
Version  : 256
Release  : 254
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-256.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-256.tar.xz
...
%prep
%setup -q -n clr-rpm-config-256
cd %{_builddir}/clr-rpm-config-256
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670874093
