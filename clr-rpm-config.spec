...
Version  : 253
Release  : 251
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-253.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-253.tar.xz
...
%prep
%setup -q -n clr-rpm-config-253
cd %{_builddir}/clr-rpm-config-253
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661525046
