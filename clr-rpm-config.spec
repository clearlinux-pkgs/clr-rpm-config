...
Version  : 269
Release  : 267
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-269.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-269.tar.xz
...
%prep
%setup -q -n clr-rpm-config-269
cd %{_builddir}/clr-rpm-config-269
pushd ..
cp -a clr-rpm-config-269 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700065878
