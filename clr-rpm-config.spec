...
Version  : 228
Release  : 228
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-228.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-228.tar.xz
...
%prep
%setup -q -n clr-rpm-config-228
cd %{_builddir}/clr-rpm-config-228
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631903652
...
cp %{_builddir}/clr-rpm-config-228/LICENSE %{buildroot}/usr/share/package-licenses/clr-rpm-config/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
