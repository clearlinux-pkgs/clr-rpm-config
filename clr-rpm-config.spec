...
Version  : 260
Release  : 258
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-260.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-260.tar.xz
...
%prep
%setup -q -n clr-rpm-config-260
cd %{_builddir}/clr-rpm-config-260
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673620733
