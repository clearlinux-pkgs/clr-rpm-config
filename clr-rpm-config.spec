...
# autospec version: v4
# autospec commit: 9dc6412
#
Name     : clr-rpm-config
Version  : 272
Release  : 270
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-272.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-272.tar.xz
...
%prep
%setup -q -n clr-rpm-config-272
cd %{_builddir}/clr-rpm-config-272
pushd ..
cp -a clr-rpm-config-272 buildavx2
popd
pushd ..
cp -a clr-rpm-config-272 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711140259
