...
Version  : 254
Release  : 252
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-254.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-254.tar.xz
...
%prep
%setup -q -n clr-rpm-config-254
cd %{_builddir}/clr-rpm-config-254
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666283468
