...
Version  : 261
Release  : 259
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-261.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-261.tar.xz
...
%prep
%setup -q -n clr-rpm-config-261
cd %{_builddir}/clr-rpm-config-261
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674587805
