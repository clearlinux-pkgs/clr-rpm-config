...
Version  : 257
Release  : 255
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-257.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-257.tar.xz
...
%prep
%setup -q -n clr-rpm-config-257
cd %{_builddir}/clr-rpm-config-257
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671638563
