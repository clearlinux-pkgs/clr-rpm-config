...
Version  : 271
Release  : 269
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-271.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-271.tar.xz
...
%prep
%setup -q -n clr-rpm-config-271
cd %{_builddir}/clr-rpm-config-271
pushd ..
cp -a clr-rpm-config-271 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706798324
