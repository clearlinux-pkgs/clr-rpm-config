...
Version  : 252
Release  : 250
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-252.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-252.tar.xz
...
%prep
%setup -q -n clr-rpm-config-252
cd %{_builddir}/clr-rpm-config-252
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659994479
