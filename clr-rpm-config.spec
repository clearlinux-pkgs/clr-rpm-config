...
Version  : 270
Release  : 268
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-270.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-270.tar.xz
...
%prep
%setup -q -n clr-rpm-config-270
cd %{_builddir}/clr-rpm-config-270
pushd ..
cp -a clr-rpm-config-270 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704295123
