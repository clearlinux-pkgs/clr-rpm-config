...
Version  : 258
Release  : 256
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-258.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-258.tar.xz
...
%prep
%setup -q -n clr-rpm-config-258
cd %{_builddir}/clr-rpm-config-258
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671639854
