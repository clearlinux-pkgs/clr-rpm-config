...
Version  : 259
Release  : 257
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-259.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-259.tar.xz
...
%prep
%setup -q -n clr-rpm-config-259
cd %{_builddir}/clr-rpm-config-259
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671720238
