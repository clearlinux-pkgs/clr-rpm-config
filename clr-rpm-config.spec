...
Version  : 250
Release  : 249
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-250.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-250.tar.xz
...
%prep
%setup -q -n clr-rpm-config-250
cd %{_builddir}/clr-rpm-config-250
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658773630
