...
Version  : 279
Release  : 278
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-279.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-279.tar.xz
...
%prep
%setup -q -n clr-rpm-config-279
cd %{_builddir}/clr-rpm-config-279
pushd ..
cp -a clr-rpm-config-279 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743005716
