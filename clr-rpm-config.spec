...
Version  : 278
Release  : 276
URL      : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-278.tar.xz
Source0  : http://localhost/cgit/projects/clr-rpm-config/snapshot/clr-rpm-config-278.tar.xz
...
%prep
%setup -q -n clr-rpm-config-278
cd %{_builddir}/clr-rpm-config-278
pushd ..
cp -a clr-rpm-config-278 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720797372
